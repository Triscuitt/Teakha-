...
public class SalesReportModule extends JPanel {
    private DefaultTableModel model;
    private JList<String> sales_reportList;
  

    public SalesReportModule() {
        ...
        add(sales_reportList, BorderLayout.WEST);
    ...
    private void loadSelectedReport(JTable table, String reportType) throws Exception {
        switch (reportType) {
            case "Daily Sales":
    ...
    private void exportToPDF(JTable table) {
        try {
            ...
            com.itextpdf.text.Font dateFont = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.HELVETICA,
            ...
            document.close();
            JOptionPane.showMessageDialog(null, "PDF Report generated: Report.pdf");
        } catch (Exception e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,
    ...
    private void performSearch(JTable table, String searchText) throws Exception {
