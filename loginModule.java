...
public class loginModule {
    ...
    public loginModule() {
        frame = new JFrame();
        frame.setSize(1197, 696);
        frame.setLayout(null);
        frame.setUndecorated(true); // Para mawala yung Title bar
        frame.setLocationRelativeTo(null); // Para ma center yung frame
    ...
    // Database connection for Log in
    // Eto yung method na nagche-check kung tama yung username at password mo sa database.
    ...
    // Customize minimize and exit button kasi wala yung title bar
    // Dito ginagawa yung sariling minimize at exit button kasi walang default na title bar.
    ...
    // Design lang to sa Top and Bottom
    ...
    // Eto yung pinakamain page ng Login module na may functionalities includes JButton, JLabel, JPanels
    ...
    private JPanel mainPage() {
        ...
        welcomeLabel.setBounds(494, 61, 210, 54);
        welcomeLabel.setText("Welcome!");
        welcomeLabel.setFont(new Font("Telegraf", Font.BOLD, 40));
        ...
        text.setBounds(300, 144, 597, 116);
    ...
    // Eto yung login page kung saan ka maglologin includes JButton, JLabel, JPanel
    ...
    private JPanel loginPage() {
        ...
        loginButton.addActionListener(e -> {
            ...
            if (role != null) {
                userSessionManager.setCurrentUser(username, role);

                frame.dispose();
                if ("admin".equalsIgnoreCase(role)) {
                    new adminDashboardModule();
                } else {
                    new guestDashboardModule();
                }
            } else {
    ...
    // Eto yung Sign Up page kung saan ka mag sisign up includes JButton, JLabel, JPanel
